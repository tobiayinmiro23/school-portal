...
function Container({menu,HandleMenu,HandleMenubarState}) {
    ...
    return (
        <div className="containerWrapper">
            <div className='container'>
                <PortalLinks menu={menu} HandleMenubarState={HandleMenubarState} HandleMenu={HandleMenu} portal={ChangePortalState}/>
